...
<template>
  ...
  <LeftInfoBlock :open="true" class="container">
    ...
    <div class="button-box">
      <button class="add-del-button" @click="add = 1" style="text-align: center"><i class="fa-solid fa-plus"></i>
        <!-- {{ t('Add satellite') }} -->
      </button>
      <button class="add-del-button" @click="remove = 1" style="text-align: center"><i class="fa-regular fa-trash-can"></i>
        <!-- {{ t('Delete satellites') }} -->
      </button>
    </div>
    <div class="orbit-sat">
